...
class RoundedImage(QLabel):
    def __init__(self, parent=None):
        ...
        # Gunakan atribut internal untuk menyimpan pixmap asli agar tidak rusak saat scaling
        self.full_pixmap = None

    def set_image(self, path, border_color):
        self.border_color = border_color
        # Load pixmap asli sekali saja
    ...
    def paintEvent(self, event):
        ...
        # Aktifkan Antialiasing & Smooth Transformation di level Painter (Ringan & Cepat)
        ...
        # Render gambar mengikuti ukuran widget saat ini secara dinamis
...
class NobaraCarousel(QWidget):
    def __init__(self):
        ...
        # UKURAN (Center lebih besar 50% dari samping)
        self.size_side = QSize(380, 214)
        self.size_center = QSize(560, 315) 
    ...
    def initUI(self):
        ...
        # POSISI TARGET: Semua dihitung berdasarkan titik tengah vertikal (mid_y)
        self.pos_targets = [
        ...
        self.name_label.setStyleSheet("color: white; font-size: 20px; font-family: 'JetBrains Mono'; font-weight: bold;")
        self.name_label.setGeometry(0, 620, 1450, 40)
    ...
    def refresh_ui(self):
        ...
        for i in range(5):
            ...
            op.setOpacity(0.0 if (i==0 or i==4) else (1.0 if is_c else 0.5))
    ...
    def animate(self, direction):
        ...
        duration = 450
        curve = QEasingCurve.Type.OutCubic # Transisi halus & stabil
        ...
        for i in range(5):
            ...
            # Animasi Posisi & Ukuran Serentak
            ...
            # Update visual instan (Border & Opacity)
    ...
    def on_finished(self):
        total = len(self.images)
        # Update gambar di slot buffer yang tidak terlihat
