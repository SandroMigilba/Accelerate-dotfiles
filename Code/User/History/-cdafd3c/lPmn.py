...
class GlassBT(QWidget):
    def __init__(self):
        ...
        self.is_scanning = False # Inisialisasi variabel scanning
        self.initUI()
    ...
    def start_scan(self):
        if not self.is_scanning:
            ...
            # Jalankan scan di latar belakang tanpa memblokir UI
            ...
            # Refresh list segera agar perangkat baru muncul bertahap
    ...
    def execute_bt_cmd(self, action, mac):
        ...
        # Gunakan Popen agar UI tidak hang selama proses pairing/koneksi
        subprocess.Popen(["bluetoothctl", action, mac], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
