...
class WifiItem(QFrame):
    ...
    def init_item(self):
        # Layout utama WifiItem dibuat sangat tipis
        self.main_vbox = QVBoxLayout(self)
        self.main_vbox.setContentsMargins(0, 0, 0, 0)
        self.main_vbox.setSpacing(0)
        self.setStyleSheet("background: transparent; border: none;")

        # Container Kotak (Satu lapis saja)
        ...
        input_h.setContentsMargins(5, 10, 5, 5)
        ...
        btn_submit.setStyleSheet("background: #00f2ff; color: black; font-weight: bold; border-radius: 5px; border: none;")
        ...
        self.main_vbox.addWidget(self.container)
...
class GlassWifi(QWidget):
    ...
    def initUI(self):
        ...
        # Header Minimalis
        header = QHBoxLayout()
        self.header_label = QLabel("📡 Wi-Fi Manager")
        ...
        self.reload_btn.setStyleSheet("""
            QPushButton { background: rgba(255,255,255,0.1); border-radius: 17px; color: white; border: none; font-size: 18px; }
        ...
        close_btn.setStyleSheet("""
            QPushButton { background: rgba(255, 80, 80, 0.3); border-radius: 17px; color: white; border: none; }
        ...
        self.list_layout.setSpacing(8) # Jarak antar kotak
