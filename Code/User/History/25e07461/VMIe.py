...
class WifiItem(QFrame):
    ...
    def init_item(self):
        ...
        # Background disamakan dengan background aplikasi (rgba 15, 15, 15, 0.9) jika active
        bg = "rgba(15, 15, 15, 0.9)" if active else "rgba(255, 255, 255, 0.05)"
        
        # Border tanpa warna cyan, menggunakan warna netral/gelap
