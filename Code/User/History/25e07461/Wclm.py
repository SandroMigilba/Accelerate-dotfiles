...
class WifiItem(QFrame):
    ...
    def init_item(self):
        ...
        btn_submit.setStyleSheet("background: #2e2e2e60; color: #f2f2f2; border-radius: 15px;")
...
class GlassWifi(QWidget):
    ...
    def execute_connect(self, ssid, password):
        ...
        # Gunakan Popen agar tidak memblock UI
        subprocess.Popen(["nmcli", "device", "wifi", "connect", ssid, "password", password])
        # Tunggu 5 detik lalu refresh untuk cek status terbaru
