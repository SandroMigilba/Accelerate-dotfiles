...
from PyQt6.QtWidgets import (QApplication, QWidget, QVBoxLayout, QPushButton, 
                             QLabel, QHBoxLayout, QScrollArea, QInputDialog, QLineEdit)
...
class GlassWifi(QWidget):
    ...
    def initUI(self):
        ...
        # Frameless agar estetik di Hyprland
        ...
        self.scan_btn.setStyleSheet("""
            QPushButton { 
                ...
                font-weight: bold; padding: 12px; margin-bottom: 5px;
            }
        """)
    ...
    def connect_wifi(self, ssid):
        # Dialog input password langsung di GUI
        password, ok = QInputDialog.getText(
            self, 'Password Required', 
            f'Masukkan password untuk {ssid}:', 
        ...
        if ok and password:
            ...
            # Hapus profil lama agar tidak konflik
            subprocess.run(["nmcli", "connection", "delete", ssid], check=False)
            
            # Hubungkan dengan password yang diinput
            cmd = ["nmcli", "device", "wifi", "connect", ssid, "password", password]
            subprocess.Popen(cmd)
            
            # Beri waktu sistem untuk menyambung sebelum refresh
